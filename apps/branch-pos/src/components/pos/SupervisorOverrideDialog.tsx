...
export function SupervisorOverrideDialog({
  ...
  const arabicPermissionName = permissionRequired === 'check:reprint' ? 'إعادة طباعة الفاتورة' : 'طباعة الفاتورة';
  const englishPermissionName = permissionRequired === 'check:reprint' ? 'Reprint Check' : 'Print Check';
